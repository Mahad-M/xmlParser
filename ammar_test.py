...
if __name__ == '__main__':
    img_files = "test/images/Zurich_Adaptable_Life_Plan_key_features_document/*.png"
    # pdf_file = "test/pdf/Ascentric_Pension_Account_SIPP_key_features_document.pdf"
    df_dir = "test/dfs"
    df_p_dir = "test/dfs_2/Zurich_Adaptable_Life_Plan_key_features_document"
    if __name__ == '__main__':
        ...
        for i, img_file in enumerate(imgs):
            if i == 9:
                ...
                ordered_boxes = create_order(column_blocks_merged, para_boxes)
